...
// Inline notification data (will be replaced with API call when notifications endpoint is built)
const mockNotifications = [
  ...
  },
  {
    ...
    description:
      'Start exploring and collecting music NFTs directly from your favorite artists.',
    time: '1 day ago',
    unread: false,
  },
  {
